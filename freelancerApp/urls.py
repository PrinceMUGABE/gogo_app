...
urlpatterns = [
    ...
    path('freelancers/', views.get_all_freelancers, name='get_all_freelancers'),
    path('update/<int:pk>/', views.update_freelancer, name='update_freelancer'),
    path('approve/<int:pk>/', views.approve_freelancer, name='approve_freelancer'),
    path('deny/<int:pk>/', views.deny_freelancer, name='deny_freelancer'),
    path('freelancer/<int:pk>/', views.get_freelancer_by_id, name='get_freelancer_by_id'),
    path('freelancer/details/<int:pk>/', views.view_freelancer_details, name='view_freelancer_details'),
    path('delete/<int:pk>/', views.delete_freelancer, name='delete_freelancer'),  # Delete freelancer
]
